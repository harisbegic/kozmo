...
session_start();
$upit = mysqli_query($konekcija, "SELECT * FROM komentari");

if(isset($_POST['komentari'])) {
  $komentar = $_POST['komentar'];
  $ime_prezime = $_POST['ime_prezime'];

  $sql = "INSERT INTO komentari (komentar, ime_prezime) VALUES ('$komentar', '$ime_prezime')";
 ...
 <body>
  ...
  <div class="w3-top">
    <div class="w3-bar w3-pink w3-card w3-left-align w3-large">
      ...
      <a href="komentari.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-white">Komentari</a>
      <?php 
...
<div class="w3-row-padding w3-padding-64 w3-container w3-center">
      ...
      <tr>
        ...
        <td><?php echo $podaci['komentar']; ?></td>
      </tr>
      <?php } ?> 
    </table>
		  <hr>
      <div class="w3-card-4 center">
		  <h3>Ostavi pozitivan ili negativan dojam</h3>
		  <form method="post" action="komentari.php" enctype="multipart/form-data" class="w3-container">
		   
		     <label>Ime i prezime</label>
		     <input type="text" name="ime_prezime" class="w3-input w3-border" required>
		   
		     <label>Komentar</label>
		     <input type="text" name="komentar" class="w3-input w3-border" required>

		     <button class="w3-button w3-green" type="submit" name="komentari" style="margin-top: 10px">Dodaj</button>
		   </div>
		  </form>
      </div>
	  </div>
