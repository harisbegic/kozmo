...
if (isset($_GET['del'])) {
	$id = $_GET['del'];
	mysqli_query($konekcija, "DELETE FROM proizvodi WHERE id=$id");
...
?>
  ...
  <div class="w3-top">
    <div class="w3-bar w3-pink w3-card w3-left-align w3-large">
     ...
     <a href="komentari.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Komentari</a>
      ...
      <a href="obrisi.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-white">Obriši proizvod</a>
 ...
 <div class="w3-row-padding w3-padding-64 w3-container w3-center">
  ...
  <?php $upit = mysqli_query($konekcija, "SELECT * FROM proizvodi"); ?>
  <table style="margin-top: 100px; margin-bottom: 50px" class="w3-table w3-bordered w3-border w3-centered">
   ...
   <?php while ($podaci = mysqli_fetch_array($upit)) { ?>
     <tr>
       <td><a href="pregled.php?pregled=<?php echo $podaci['id']; ?>"><?php echo $podaci['ime']; ?></a></td>
       <td><?php echo $podaci['vrsta']; ?></td>
       <td><?php echo $podaci['cijena']; ?></td>
       <td>
         <a href="obrisi.php?del=<?php echo $podaci['id']; ?>" class="w3-button w3-red">Obriši</a>
       </td>
     </tr>
   <?php } ?>
  </table>
