<?php include "konekcija.php";  session_start();?>
 ...
 <div style="margin-top: 100px; margin-bottom: 50px">
   <div class="w3-bar w3-border w3-light-grey">
     <a href="katalog-1.php" style="width:33.33%" class="w3-bar-item w3-button w3-mobile w3-indigo">Kreme</a>
 ...
 <!-- Kod -->
 <?php $upit = mysqli_query($konekcija, "SELECT * FROM proizvodi WHERE vrsta='Krema'"); ?>
 <div class="w3-row">
